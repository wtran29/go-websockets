...
// wsChan only accepts WsPayload
var wsChan = make(chan WsPayload)

// clients are the ones that are connected to the ws connection
...
// upgradeConnection is the websocket upgrader from gorilla/websocket lib
